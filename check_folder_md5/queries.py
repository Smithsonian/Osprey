...
file_postprocessing1 = "INSERT INTO file_postprocessing (file_id, post_step, post_results) VALUES (SELECT file_id, 'md5_matches', 0 FROM files WHERE folder_id =  %(folder_id)s)"

file_postprocessing2 = "INSERT INTO file_postprocessing (file_id, post_step, post_results) VALUES (SELECT file_id, 'ready_for_dams', 9 FROM files WHERE folder_id =  %(folder_id)s)"

file_postprocessing3 = "INSERT INTO file_postprocessing (file_id, post_step, post_results) VALUES (SELECT file_id, 'in_dams', 9 FROM files WHERE folder_id =  %(folder_id)s)"
